...
export function UserManagement() {
  ...
  const departments = ['COLETA', 'COMPRAS', 'TRANSPORTES', 'VENDAS', 'RH', 'TI', 'SAC MONIT', 'TRANSPORTE', 'T CONTROLE', 'ARM EXPED', 
  'FATURAMENT', 'MECANICA', 'SEGUR TRAB', 'C EXT AGEN' , 'CONTABIL', 'COMERCIAL', 'ACERTO', 'ROTEIRIZAC', 'ARM RECEB', 'REVER PROD',
  'REVER PALL', 'QUALIDADE', 'MANUT PRED', 'DP', 'AGREGAMENT', 'CUSTO EXTRA', 'CONTROLAD', 'GEST FRONT'];
  const positions = ['Gerente', 'Supervisor', 'Analista', 'Assistente', 'Operador', 'Auxiliar', 'Diretor'];
